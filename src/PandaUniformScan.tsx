                ...
                <>
                  ...
                  <Button
                    onClick={() => {
                      setPvs(prev => [
                        ...prev,
                        [plan.pv_id, plan.pv_name, plan.pv_datatype, plan.pv_min_threshold, plan.pv_max_threshold, plan.pv_ensure_in_range, plan.pv_compute_snr, plan.pv_snr_min_threshold],
                      ]);
                    }}
                  >
                    Add PV
